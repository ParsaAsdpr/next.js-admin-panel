...
const SidebarButton = ({
    ...
    return (
        ...
        <a className='w-full py-4 font-bold cursor-pointer transition flex-row flex justify-between  pl-12 px-7 items-center text-xl' href={null ? null : url} onClick={handleClick}>
            {title}
